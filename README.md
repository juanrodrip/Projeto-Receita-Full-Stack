...
Este é um projeto simples de página web feito com **HTML** e **CSS**, que apresenta uma receita deliciosa de *Cupcake de café com chantilly*. Ideal para quem está começando a praticar desenvolvimento web e quer treinar a estruturação e estilização de páginas.

---

## 🔍 Prévia do Projeto

![Prévia do Projeto](https://github.com/user-attachments/assets/e9a3f2f7-00f7-4198-bdb1-b960497fc4f3)
    ...
    <div id="page">
        ...
        <main>
            <section id="about">
                ...
                <p>O bolinho perfeito para acompanhar o café de todos os dias. É muito fácil e ainda por cima fica
            ...
            <section id="preparation">
                ...
                <p>No liquidificador, bata a água, o café solúvel, os ovos, o óleo, o açúcar e o chocolate em pó até
                    ...
                    dentro de um saco de confeiteiro com bico pitanga e reserve. <br><br>
                    ...
                    café e leve à geladeira até o momento de servir.</p>
            </section>
        </main>
    </div>
